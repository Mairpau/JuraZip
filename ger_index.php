  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#page-top" class="page-scroll">Homepage</a></li>
        <li><a href="#about" class="page-scroll">Vorstellung des Unternehmens</a></li>
        <li><a href="#catalogue" class="page-scroll">Katalog</a></li>
        <li><a href="#contact" class="page-scroll">Kontakt</a></li>
        <li><a href="panier.php" class="">Korb</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse -->
  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            ...
            <p>Willkommen auf unsere Seite Jura'Zip</p>
            <a href="#catalogue" class="btn btn-custom btn-lg page-scroll">Unsere Produkte</a></div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2>Unser Betrieb.</h2>
          <p>Wir sind eine kleine Schweitzer Firma, genauer gesagt, wir sind aus dem Jura.</p>
          <h3>Unsere Stärke</h3>
          <div class="list-style">
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <ul>
                ...
                <li>Einige Format</li>
                <li>Einmalige Auswahl an Farben.</li>
                <li>Ori­gi­na­li­tät</li>
              </ul>
            </div>
          </div>
        </div>
...
<div id="catalogue" class="text-center">
  <div class="container">
    <div class="col-md-8 col-md-offset-2 section-title">
      ...
      <p>Alle Mäppchen sind Lokal und Handgemacht. </p>
    </div>
    <div id="row">
...
<div id="contact">
  <div class="container">
    <div class="col-md-8">
      <div class="row">
        <div class="section-title">
          ...
          <p>Wobei können wir dir helfen ?</p>
        </div>
        <form name="sentMessage" id="contactForm" novalidate>
          ...
          <div class="form-group">
            <textarea name="message" id="message" class="form-control" rows="4" placeholder="Eure Nachricht" required></textarea>
            <p class="help-block text-danger"></p>
          </div>
          <div id="success"></div>
    ...
    <div class="col-md-3 col-md-offset-1 contact-info">
      ...
      <div class="contact-item">
        <p><span><i class="fa fa-phone"></i> Telephon</span> 012 123 12 12</p>
      </div>
      <div class="contact-item">
...
<div id="footer">
  <div class="container text-center">
    <p>&copy; Alle Rechte vorbehalten an <a href="http://www.jurazip.ch" rel="nofollow">Jura'Zip</a></p>
  </div>
</div>
